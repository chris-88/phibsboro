...
// Generated by the shadcn CLI, then edited. The two `toLocale*` calls the CLI emits (a dropdown
// month formatter and a `data-day` attribute) are removed: the app bans `toLocale*` in favour of
// formatEventTime (D35), and this calendar uses the plain `label` caption, not the dropdown.
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      data-day={`${String(day.date.getFullYear())}-${String(day.date.getMonth() + 1)}-${String(day.date.getDate())}`}
